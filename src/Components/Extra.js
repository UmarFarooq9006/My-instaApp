                ...
                <div className="container border">
                    ...
                    <div className="row ml-0 my-3">
                        ...
                        <div className="  my-2 HaiderBhaiCommentImg">
                            <img src="/Img/hamzasajjad.jpg" alt="" />
                        </div>
                                                ...
                                                <div className='border HaiderBhaiCommentCard1st'>
                                                    ...
                                                    <div className="row mt-2">
                                                        ...
                                                        <div className="col-3 HaiderBhaiCommentImgCard  ">
                                                            ...
                                                            <img className='my-3 ml-3' src="/Img/hamzasajjad.jpg" alt="" />
                    ...
                    <div className="row">
                        ...
                        <div className="col-4 border-left mb-4">
                            ...
                            <div className="row">
                                ...
                                <div className="col-8">
                                    <img className='commentRightVideo' src="/Img/hamzasajjad.jpg" alt="" />
                                </div>
